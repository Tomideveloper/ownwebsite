    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="<?php echo e(url('profile/list')); ?>">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?php echo e(url('work_experience/list')); ?>">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?php echo e(url('education/list')); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(url('user/list')); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(url('contact/list')); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(url('message/list')); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(url('login')); ?>">
  ...
  </aside><!-- End Sidebar--><?php /**PATH D:\xamp\htdocs\projects_no1\resources\views/admin/inc/sidebar.blade.php ENDPATH**/ ?>