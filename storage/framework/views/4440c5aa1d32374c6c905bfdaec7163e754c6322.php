...
<head>
  ...
  <title>3D Portfolio Website | Amenu</title>
  <link rel="stylesheet" href="<?php echo e(url('public/frontendassests/style.css')); ?>" />
  <!-- box icons -->
  <link
...
<body>
    ...
    <div class="book">
      ...
      <div class="book-page page-left">
        <div class="profile-page">
          <img src="<?php echo e(url('public/profilepic/',$profiles->image)); ?>" alt="" />
          <h1><?php echo e($profiles->name); ?></h1>
          <h3><?php echo e($profiles->profession); ?> </h3>
          <div class="social-media">
            <a href="<?php echo e($profiles->fb_link); ?>"><i class="bx bxl-facebook"></i></a>
            <a href="<?php echo e($profiles->tk_link); ?>"><i class="bx bxl-twitter"></i></a>
            <a href="<?php echo e($profiles->linkedin_link); ?>"><i class="bx bxl-linkedin"></i></a>
            <a href="<?php echo e($profiles->insta_link); ?>"><i class="bx bxl-instagram-alt"></i></a>
          </div>
          <p>
           <?php echo e($profiles->description); ?>
      ...
      <div class="book-page page-right turn" id="turn-1">
        ...
        <div class="page-front">
          ...
          <div class="workeduc-box">
            ...
            <div class="workeduc-content">
              <span class="year"><i class="bx bx-calendar"></i><?php echo e($work->date); ?></span>
              <h3><?php echo e($work->education); ?></h3>
              <p>
        ...
        <div class="page-back">
          ...
          <div class="workeduc-box">
            ...
            <div class="workeduc-content">
              <span class="year"><i class="bx bx-calendar"></i><?php echo e($edu->time); ?></span>
              <h3><?php echo e($edu->title); ?></h3>
              <p>
      ...
      <div class="book-page page-right turn" id="turn-3">
        ...
        <div class="page-front">
          ...
          <!-- next button -->
          <span class="nextprev-btn" data-page="turn-3"><i class="bx bx-chevron-right"></i></span>
        </div>
        <!-- page 6 (contact me) -->
        <div class="page-back">
          ...
          <div class="contact-box">
            <form action="<?php echo e(url('insert')); ?>" method="post">
              ...
              <div>
                <p  class="message">Thanks for sending your reponse </p></div>
            </form>
          </div>
  ...
  <script src="<?php echo e(url('public/frontendassests/script.js')); ?>"></script>
</body>

</html><?php /**PATH D:\xamp\htdocs\projects_no1\resources\views/frontend/index.blade.php ENDPATH**/ ?>